...
export const API_PATHS = {
  ...
  RESUME: {
    ...
    DELETE: (id) => `/api/resume/${id}`, // DELETE - Delete a resume ✅ (was incorrect before)
    UPLOAD_IMAGE: (id) => `/api/resume/${id}/upload-images`, // POST - Upload resume image
  },
  IMAGE: {
    UPLOAD_IMAGE: "/api/auth/upload-image", // Added leading slash ✅
  },
};
